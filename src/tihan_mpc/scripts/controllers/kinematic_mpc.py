...
class KinMPCPathFollower(Controller):
	...
	def __init__(self, 
		        ...
		        #  L_F        = 3, # distance from CoG to front axle (m)
		        #  L_R        = 4, # distance from CoG to rear axle (m)
		         ...
		         DF_MAX     =  0.65,    
		         A_DOT_MIN  = -1.5,   # min/max jerk constraint (m/s^3)  ## -1.5
		         A_DOT_MAX  =  1.5,                ## 1.5
		         DF_DOT_MIN = -0.65,   # min/max front steer angle rate constraint (rad/s)  -0.5
		         DF_DOT_MAX =  0.65,       ## 0.5
