...
class mpc_path {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('wp_end')) {
        this.wp_end = initObj.wp_end
      }
      else {
        this.wp_end = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [wp_end]
    bufferOffset = _serializer.bool(obj.wp_end, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [wp_end]
    data.wp_end = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.solve_status);
  ...
  static datatype() {
    ...
    return 'tihan_mpc/mpc_path';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '85e4d761326cc6c39a08e19f13b42c05';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.wp_end !== undefined) {
      resolved.wp_end = msg.wp_end;
    }
    else {
      resolved.wp_end = false
    }
